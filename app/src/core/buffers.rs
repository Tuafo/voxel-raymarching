use crate::core::{camera::Camera, transform::ModelTransform};
...
impl CameraDataBuffer {
    pub fn from_camera(camera: &Camera, jitter: glam::DVec2) -> Self {
        Self {
...
impl ModelDataBuffer {
    pub fn update(&mut self, model: &ModelTransform) {
