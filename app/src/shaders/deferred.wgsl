...
fn compute_main(in: ComputeIn) {
    ...
    let illumination = textureLoad(tex_illumination, pos, 0).rgb;
    let shadow_factor = illumination.r;
    ...
    var color = albedo * (diff * DIRECTIONAL_INTENSITY * shadow_factor + AMBIENT_INTENSITY);
