...
impl Voxelizer {
    ...
    pub fn load_gltf(
        ...
        let allocated = pack_tree(device, queue, &mut tree);
    ...
    fn build_tree(
        ...
        let bg_tree_data_a = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: buffer_index_map_a.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: buffer_index_map_b.as_entire_binding(),
                },
            ],
        });
...
fn pack_tree(device: &wgpu::Device, queue: &wgpu::Queue, tree: &mut TreeData) -> AllocatorResults {
    let alloc_results = {
